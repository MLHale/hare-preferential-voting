...
# @Last modified time: 2018-04-24T00:15:35-05:00
...
with open(args.ballots) as ballotfile:
    for line in csv.reader(ballotfile, delimiter=','):
        if line[0] == "start":
            ...
            # All ballots for this electio have been parsed, perform HARE tabulation
            ...
            while len(ranked_winners) != slots:
                ...
                for candidate in candidates:
                    if top_ranked_votes.count(candidate) > hare_quota:
                        print "we have a winner and its %s" % candidate
                ...
                if len(potential_winners) > slots:
                    ...
                    for winner in potential_winners:
                        ...
                        transfer_ballots = filter(lambda ballot: ballot[0]==winner,ballots_current)
                        print transfer_ballots
                        for index, ballot in enumerate(transfer_ballots):
                ...
                # break
            print "The winners are:", ranked_winners
            current_election=""
            print "...Done"
        else:
